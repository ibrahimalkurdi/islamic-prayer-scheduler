...
| **جلب الإصدارات** | يجلب قائمة الإصدارات المنشورة، وتحتاجها القائمتان أدناه قبل استعمالهما | — |
...
اختر إصدارًا من القائمة ثم اضغط **تثبيت الإصدار المحدد**. وعندها **يتوقف الجهاز عن متابعة
التحديث المركزي**، فتظهر عبارة **مثبَّت على الإصدار … — لا يتبع التحديث المركزي** ومعها زر
**العودة إلى التحديث المركزي** الذي يعيده إلى متابعة الإصدار المعتمد.

> لا يظهر هذا الزر إلا إذا كان الجهاز مثبَّتًا على إصدار فعلًا.
...
تُنزَّل من الشبكة، ولا تظهر قبل الضغط على **جلب الإصدارات**. ولا يُحتفظ إلا بنسخة محفوظة
واحدة، فكل تحديث جديد يستبدل التي قبله.

> الرجوع إلى إصدار سابق **يثبّت** الجهاز عليه أيضًا، وإلا أعاده الفحص التالي في الليلة
> نفسها إلى الإصدار الذي رجعت عنه. وللعودة إلى المتابعة المركزية اضغط
> **العودة إلى التحديث المركزي**.
